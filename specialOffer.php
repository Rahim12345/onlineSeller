...
?>
				...
				<div class="col-9">
					<div class="tab-content" id="v-pills-tabContent">
						...
						<div class="row">
<?php  
		$query4Products=$conn->prepare("SELECT * FROM products WHERE endirim!=? ORDER BY id DESC");
		$query4Products->execute([0]);
		...
		<div class="col-lg-4 col-md-6 special-grid drinks">
			<div class="gallery-single fix">
				...
				<div class="why-text">
					<h4>'.$name.'<span style="position:absolute;right:0;top:0;background-color: #ff0700;border-radius: 50%;font-size:10px;color: white;font-weight: bold;padding:10px;">'.$rows4Product['endirim'].' %</span></h4>
